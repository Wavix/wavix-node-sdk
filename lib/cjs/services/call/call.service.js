...
class Call extends service_base_1.default {
    ...
    start(payload) {
        return this.http.post("/v1/call", Object.assign(Object.assign({}, payload), { call_recording: payload.call_recording || false, machine_detection: payload.machine_detection || false }));
    }
    playAudio(callUUID, url, options) {
        return this.http.post(`/v1/call/${callUUID}/play`, {
            audio_file: url,
            timeout_before_playing: (options === null || options === void 0 ? void 0 : options.timeout_before_playing) || 0,
            timeout_between_playing: (options === null || options === void 0 ? void 0 : options.timeout_between_playing) || 0
        });
    }
    /**
     * Voice list
    ...
    tts(callUUID, text, options) {
        return this.http.post(`/v1/call/${callUUID}/tts`, {
            text,
            voice: (options === null || options === void 0 ? void 0 : options.voice) || "Joey",
            delay_before_playing: (options === null || options === void 0 ? void 0 : options.delay_before_playing) || 0,
            max_repeat_count: (options === null || options === void 0 ? void 0 : options.max_repeat_count) || 0
        });
    }
