 ...
 */
export interface UpdateBrandsResponse {
    ...
    company_name: string;
    /** Company entity type. */
    entity_type: UpdateBrandsResponse.EntityType;
    ...
    status: UpdateBrandsResponse.Status;
...
export namespace UpdateBrandsResponse {
    /** Company entity type. */
